            ...
            if not no_guardar:
                try:
                    ...
                    try:
                        ...
                        result["pdfUrl"]=f"/api/pdf/{no_serie}"; result["pdfStatus"]="PDF listo (weasyprint)"
                    except Exception as e1:
                        print(f"weasyprint fallo ({no_serie}): {e1}")
                        try:
                            from fpdf import FPDF
                            ...
                            result["pdfError"]=str(e2)
                            print(f"PDF fallo ({no_serie}): {e2}")
                except: pass
            return result
